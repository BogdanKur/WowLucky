package com.example.wowlucky.screens.onboarding.adapter
...
class ContinueViewPagerAdapter : ListAdapter<Continue, ContinueViewPagerAdapter.ContinueViewPagerViewHolder>(
